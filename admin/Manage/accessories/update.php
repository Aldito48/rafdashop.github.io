            ...
            <h1>Baju</h1>
                ...
                <div class="content">
                    <?php                        
                        ...
                        $id = @$_GET['id'];
                        $sql_baju = mysqli_query($con, "SELECT * FROM product WHERE ID = '$id' AND jenis = 'Accessories'") or die (mysqli_error($con));
                    ...
                    ?>
                            <form action="proses.php" method="POST" enctype="multipart/form-data">
                                ...
                                <div>
                                    ...
                                    <textarea id="deskripsi" name="deskripsi" placeholder="Masukkan Deskripsi..."><?=$data['deskripsi']?></textarea>
                                </div>
                                <div>
                                        ...
                                        echo "<select id=\"jenis\" name=\"jenis\" disabled>
                                            ...
                                            while($result = mysqli_fetch_row($jenis)){
                                                foreach(explode("','",substr($result[1],6,-2)) as $option){
                                                    $selected = ($option == 'Accessories') ? 'selected' : '';
                                ...
                                <div>
                                    ...
                                    <textarea id="link" name="link" placeholder="Masukkan Link..."><?=$data['link']?></textarea>
                                </div>
                                <div class="tmbl1">
