            ...
            <h1>Bags</h1>
                ...
                <div class="content">
                    <?php
                        ...
                        $id = @$_GET['id'];
                        $sql_baju = mysqli_query($con, "SELECT * FROM product WHERE ID = '$id' AND jenis = 'Bags'") or die (mysqli_error($con));
                    ...
                    ?>
                            <form action="proses.php" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="hidden" name="jenis" value="Bags">
                                    <?php
