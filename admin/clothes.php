    ...
    <body>
        <main class="table">
            ...
            <section class="table__header">
                ...
                <h1><span><i class="fa-solid fa-table-cells-large"></i></span> Clothes</h1>
                ...
                <div class="setting-right"> 
                    <a href="Manage/clothes/insert.php"><i class="fa-solid fa-circle-plus"></i></a>
                            ...
                            <?php
                                ...
                                if ($_SERVER['REQUEST_METHOD'] == "POST") {
                                    ...
                                    if ($pencarian != '') {
                                        ...
                                        $query = "SELECT * FROM product WHERE jenis = 'Clothes'";
                                ...
                                $data_baju = mysqli_query($con, $query) or die (mysqli_error($con));
                                if(mysqli_num_rows($data_baju) > 0){
                                    while($data = mysqli_fetch_array($data_baju)){
                            ?>
                                        <tr>
                                            ...
                                            <td align="center">Rp. <?=formatRupiah($data['harga'])?></td>
                                            <td align="center"><?=$data['jenis']?></td>
                                            <td align="center"><a href="<?=$data['link']?>" target="_blank">Show</a></td>
                                            <td align="center">
                                                <a href="Manage/clothes/update.php?id=<?=$data['ID']?>"><i class="fa-solid fa-pen-to-square"></i></a>
                                                <a href="Manage/clothes/delete.php?id=<?=$data['ID']?>" onclick="return confirm('Data Ini Akan Dihapus')"><i class="fa-solid fa-trash"></i></a>
                                            </td>
                                        </tr>
                            <?php
                                    }
                                } else{
                                    echo "There's No Clothes";
                                }
                            ?>
                        </tr>
                    </tbody>
