...
<head>
    ...
    <title>Product | Rafda Shop</title>
...
<body>
    ...
    <div class="sort" data-aos="fade-down" data-aos-delay="1000" data-aos-duration="2000">
        <ul class="indicator">
            <li class="active"><a href="product.php">All</a></li>
            <li><a href="fashion/clothes.php">Clothes</a></li>
            <li><a href="fashion/pants.php">Pants</a></li>
            <li><a href="fashion/shoes.php">Shoes</a></li>
            <li><a href="fashion/bags.php">Bags</a></li>
                ...
                <div class = "product-items">
                    <?php
                        ...
                        if ($_SERVER['REQUEST_METHOD'] == "POST") {
                            ...
                            if ($pencarian != '') {
                                $sql = "SELECT * FROM product WHERE nama LIKE '%$pencarian%'";
                                $query = $sql;
                                $queryJml = $sql;
                            } else{
                                $query = "SELECT * FROM product LIMIT $posisi, $batas";
                                $queryJml = "SELECT * FROM product";
                                $no = $posisi + 1;
                            }
                        } else {
                            $query = "SELECT * FROM product LIMIT $posisi, $batas";
                        ...
                        $all = mysqli_query($con, $query) or die (mysqli_error($con));
