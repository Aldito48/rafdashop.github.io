...
<body>
    ...
    <div class="sort" data-aos="fade-down" data-aos-delay="1000" data-aos-duration="2000">
        <ul class="indicator">
            ...
            <li class="active"><a href="bags.php">Bags</a></li>
                    ...
                    <?php
                        ...
                        if ($_SERVER['REQUEST_METHOD'] == "POST") {
                            ...
                            if ($pencarian != '') {
                                ...
                                $query = "SELECT * FROM product WHERE jenis = 'Bags' LIMIT $posisi, $batas";
                        ...
                        $bgs = mysqli_query($con, $query) or die (mysqli_error($con));
                        if(mysqli_num_rows($bgs) > 0){
                            while($data = mysqli_fetch_array($bgs)){
                    ?>
                                <!-- single product -->
