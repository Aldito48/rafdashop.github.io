...
<head>
    ...
    <title>Accessories | Rafda Shop</title>
                    ...
                    <?php
                        ...
                        if ($_SERVER['REQUEST_METHOD'] == "POST") {
                            ...
                            if ($pencarian != '') {
                                ...
                                $query = "SELECT * FROM product WHERE jenis = 'Accessories' LIMIT $posisi, $batas";
                        ...
                        $aks = mysqli_query($con, $query) or die (mysqli_error($con));
                        if(mysqli_num_rows($aks) > 0){
                            while($data = mysqli_fetch_array($aks)){
                    ?>
                                <!-- single product -->
