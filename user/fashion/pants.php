...
<body>
    ...
    <div class="sort" data-aos="fade-down" data-aos-delay="1000" data-aos-duration="2000">
        <ul class="indicator">
            ...
            <li class="active"><a href="pants.php">Pants</a></li>
                    ...
                    <?php
                        ...
                        if ($_SERVER['REQUEST_METHOD'] == "POST") {
                            ...
                            if ($pencarian != '') {
                                ...
                                $query = "SELECT * FROM product WHERE jenis = 'Pants' LIMIT $posisi, $batas";
                        ...
                        $pts = mysqli_query($con, $query) or die (mysqli_error($con));
                        if(mysqli_num_rows($pts) > 0){
